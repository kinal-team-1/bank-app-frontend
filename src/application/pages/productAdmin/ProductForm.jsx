...
import { postProduct } from "../../actions/POST/post-product";
...
export function ProductForm() {
  ...
  const mutation = useMutationWithToast(postProduct, {
  ...
  return (
    <div className="flex flex-col gap-10 py-5 px-5 h-full overflow-y-scroll">
      <h1 className="text-5xl w-full text-center">Product Form</h1>
      <div className="flex justify-center">
        <form
          ...
          onSubmit={(e) => {
            ...
            mutation.mutate({ product: form, locale });
          }}
        >
